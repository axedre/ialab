...
\tikzstyle{startstop} = [rectangle, rounded corners, minimum width=3cm, text centered, draw=black, fill=red!30] %minimum height=1cm
\tikzstyle{io} = [trapezium, trapezium left angle=70, trapezium right angle=110, minimum width=3cm, text centered, draw=black, fill=blue!30] %minimum height=1cm
\tikzstyle{process} = [rectangle, minimum width=3cm, text centered, draw=black, fill=orange!30] %minimum height=1cm
\tikzstyle{decision} = [diamond, minimum width=3cm, text centered, draw=black, fill=green!30] %minimum height=1cm
