...
% - La parte cumulativa, dove devono essere impostate le regole cumulative che persistono 
%(che sono mantenute) in tutti gli step, ma dipendono dal parametro incrementale.
% - La parte volubile, dove devono esserci le query al programma, che devono contenere solo 
%l'ultimo stato
...
0 { vola(P,DA,A,s) : aereo(P) : aeroporto(DA) : aeroporto(A) : DA!=A } 1 .
